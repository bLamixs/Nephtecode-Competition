...
class ReliabilityAgent:
    ...
    async def assess(self, telemetry: pd.DataFrame) -> ReliabilityAssessment:
        """
        Асинхронный интерфейс для вызова Оркестратором (await self.reliability_agent.assess(telemetry)).
        """
